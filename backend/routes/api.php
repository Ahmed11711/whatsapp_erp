...
Route::post('/whatsapp/webhook/test', function (Request $request) {
    Log::info('WhatsApp webhook test', $request->all());
...
Route::middleware(['auth.api'])->group(function () {
    ...
    Route::get('/whatsapp/status', [MessageController::class, 'checkWhatsAppStatus']); // check WhatsApp API status
});
